...
/// A widget that shows growing up progress indicator in sliver
class SLiverProgressIndicator extends SingleChildRenderObjectWidget {
...
class _SpinnerRenderSliver extends RenderSliver with RenderObjectWithChildMixin<RenderBox> {
  ...
  void performLayout() {
    ...
    if (remainingCacheExtent > 0 && scrollOffset == 0 && paintedChildSize > 0) {
